...
if readiness["runtime_identity_sha256"]!=readiness["runtime_identity"]["runtime_fingerprint_sha256"] or readiness["runtime_fingerprint"]!=pinned_fingerprint: raise SystemExit("readiness identity binding differs")
