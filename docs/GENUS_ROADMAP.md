...
**Rot — der nächste Schritt:** mehr Nomen mit Genus seeden/organisch wachsen lassen; *oder* tiefer in **Phase C/D** (weitere Selbst-Parameter; Erschaffen/Selbst-Codieren). Das LLM bleibt am Rand, gedeckelt. (Optional: Sprachen en/fr. Offen: die Atlas-Karten für die gesamte Genus-Regel-Scheibe fehlen noch.)
