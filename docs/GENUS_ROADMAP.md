...
**Rot — der nächste Schritt:** die **Stimme** (freies, natürliches Formulieren statt Templates) — der zweite offene Plausch-Kurs-Schritt. Parallel offen: Phase D (früh), weitere Regel-Domänen, Korrelation≠Kausalität, Ziel-Objekt. Das LLM bleibt am Rand, gedeckelt.
