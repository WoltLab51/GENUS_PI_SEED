...
**Rot — der nächste Schritt:** tiefer in **Phase D** (Erschaffen/Selbst-Codieren, noch früh) *oder* eine weitere Regel-Domäne für SYSTEME *oder* die restlichen Handlungs-Lücken (Korrelation≠Kausalität; ein erstklassiges Ziel-Objekt). Das LLM bleibt am Rand, gedeckelt. (Optional: mehr Nomen seeden, Sprachen en/fr, oder Pronomen-Nachfragen.)
