...
**Rot — der nächste Schritt:** eine Absicht/Fähigkeit für Wetter-/Prognosefragen (heute unbenannt, fällt auf eine falsche Kategorie), Treffer-Quote-Kennzahl aus Folge-Signalen (lernt, WELCHE Bausteine je Zelle nützen), Scan-Differenzierung neuer Ausprägungen aus den gesammelten free_readings, Raster-Inquiries (GENUS fragt bei Unsicherheit nach), Plural-Morphologie beim Objekt einer Beziehungsfrage, Phase D (früh), Korrelation≠Kausalität, Ziel-Objekt. Das LLM bleibt am Rand, gedeckelt.
