...
**Rot — der nächste Schritt:** tiefer in **Phase D** (Erschaffen/Selbst-Codieren, noch früh) *oder* eine weitere Regel-Domäne für SYSTEME. Das LLM bleibt am Rand, gedeckelt. (Optional: mehr Nomen seeden, Sprachen en/fr, oder dem Bot „Woher weißt du das?" als Warum-Frage beibringen.)
