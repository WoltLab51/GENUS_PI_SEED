...
**Rot — der nächste Schritt:** die **Schicht SYSTEME** (Phase B, der Denk-Sprung): in einer prüfbaren Domäne Regeln lernen + schließen + sich selbst testen (Grammatik zuerst); das LLM bleibt am Rand, gedeckelt. (Optional offen aus Phase A: weitere Sprachen en/fr über die Konzepte.)
