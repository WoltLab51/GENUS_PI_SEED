...
**Rot — der nächste Schritt:** die Ausnahmen-Erkennung an den Begleiter anschließen (`genus ask` könnte Genus-Fragen beantworten); mehr Nomen mit Genus seeden/organisch wachsen lassen; *oder* tiefer in **Phase C/D** (weitere Selbst-Parameter; Erschaffen/Selbst-Codieren). Das LLM bleibt am Rand, gedeckelt. (Optional: Sprachen en/fr. Offen: die Atlas-Karten für diese Scheibe fehlen noch — nachziehen, sobald mehr Nomen mit Genus vorliegen.)
