...
**Rot — der nächste Schritt:** SYSTEME in die **Breite** (weitere Regel-Domänen, z. B. Grammatik über eine Formen-Membran) *oder* tiefer in **Phase C/D** (weitere Selbst-Parameter; Erschaffen/Selbst-Codieren). Das LLM bleibt am Rand, gedeckelt. (Optional: Sprachen en/fr.)
