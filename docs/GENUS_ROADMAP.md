...
**Rot — der nächste Schritt:** Personen-Gedächtnis Scheibe 2 (automatische/passive Erkennung statt nur „Merke dir: …"), Antwort-Komposition als eigener Würfel (im Verstehens-Würfel schon mitgedacht: eine Zelle indexiert später *beides*, wie gedeutet UND wie geantwortet wird — Kompositions-Fähigkeit lernbar über Folge-Signale). Parallel offen: Treffer-Quote-Kennzahl aus Folge-Signalen, Scan-Differenzierung neuer Ausprägungen, Raster-Inquiries (GENUS fragt bei Unsicherheit nach), Plural-Morphologie beim Objekt einer Beziehungsfrage, Phase D (früh), Korrelation≠Kausalität, Ziel-Objekt. Das LLM bleibt am Rand, gedeckelt.
