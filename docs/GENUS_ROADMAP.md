...
**Rot — der nächste Schritt:** **SYSTEME ①c** — **Überraschung bei Regel-Verletzung**: ein neu behaupteter is_a-Zyklus verletzt die (gelernte) Azyklizität → Surprise → Inquiry, wie beim Wissens-Widerspruch; dann weitere Regel-Domänen. Das LLM bleibt am Rand, gedeckelt. (Optional offen aus Phase A: weitere Sprachen en/fr.)
