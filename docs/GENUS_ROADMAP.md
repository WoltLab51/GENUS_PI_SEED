...
**Rot — der nächste Schritt:** tiefer in **Phase D** (Erschaffen/Selbst-Codieren, noch früh) *oder* eine weitere Regel-Domäne für SYSTEME *oder* die nächste Handlungs-Lücke (Kontext/Gespräch — der Begleiter hat noch kein Gedächtnis; oder Kausalität; oder ein erstklassiges Ziel-Objekt). Das LLM bleibt am Rand, gedeckelt. (Optional: mehr Nomen seeden, Sprachen en/fr, oder dem Bot „Woher weißt du das?" als Warum-Frage beibringen.)
