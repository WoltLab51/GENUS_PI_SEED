...
**Rot — der nächste Schritt:** mehr Nomen mit Genus seeden/organisch wachsen lassen; *oder* tiefer in **Phase D** (Erschaffen/Selbst-Codieren, noch früh). Das LLM bleibt am Rand, gedeckelt. (Optional: Sprachen en/fr. Offen: die Atlas-Karten für die Genus-Regel-Scheibe fehlen noch.)
