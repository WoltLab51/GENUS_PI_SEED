...
**Rot — der nächste Schritt:** tiefer in **Phase D** (Erschaffen/Selbst-Codieren, noch früh) *oder* eine weitere Regel-Domäne. Das LLM bleibt am Rand, gedeckelt. (Optional: Sprachen en/fr.)
