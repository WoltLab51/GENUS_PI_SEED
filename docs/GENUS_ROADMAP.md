...
**Rot — der nächste Schritt:** die **Stimme** (freies, natürliches Formulieren statt Templates) oder **Personen-Gedächtnis** als eigener Design-Schritt (berührt bewusst „Ledger ≠ Memory"). Parallel offen: Phase D (früh), weitere Regel-Domänen, Korrelation≠Kausalität, Ziel-Objekt. Das LLM bleibt am Rand, gedeckelt.
