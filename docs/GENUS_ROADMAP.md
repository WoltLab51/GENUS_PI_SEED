...
**Rot — der nächste Schritt:** **weitere Regel-Domänen** (SYSTEME in die Breite — z. B. Grammatik über eine Formen-Membran) *oder* der Sprung in **Phase C** (Selbst-Bezug/Optimierung: SYSTEME auf die eigenen Parameter). Das LLM bleibt am Rand, gedeckelt. (Optional offen aus Phase A: weitere Sprachen en/fr.)
