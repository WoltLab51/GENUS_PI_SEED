...
"Registriert" heißt heute: Python-Prozess-Registry (wie RULES/DETECTORS/REACTORS), kein
Ledger-Event. Das ist eine bewusste Grenze, keine Vergesslichkeit: eine Ledger-gestützte
Registrierung (mit Herkunft, gated für modell-vorgeschlagene Werkzeuge) wird erst gebraucht,
wenn Stufe 1/2 GENUS selbst Werkzeuge vorschlagen lässt -- vorher wäre sie Vorrats-Komplexität.
"""
