...
def characterize_knowledge(conn, weakest: int = 5) -> dict:
    ...
    return {
        ...
        # self-calibration turned on reasoning itself: the transitivity threshold GENUS derived
        # from the natural gap in its own data and RECORDED (the active value inference reasons by,
